...
const config = {
  title: '东山PI',
  tagline: 'DshanPI E UI Docs.',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://eui.100ask.net',
  ...
  projectName: 'eUI-TrainingDocs', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/100askTeam/eUI-TrainingDocs/tree/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/100askTeam/eUI-TrainingDocs',
            label: 'GitHub',
            position: 'right',
          },
        ],
